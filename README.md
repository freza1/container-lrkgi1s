...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-lrkgi1s.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-lrkgi1s.containers.anotherwebservice.com/
...
```
git clone git@github.com:freza1/container-lrkgi1s.git
cd container-lrkgi1s
```
...
```
docker attach container-lrkgi1s
```
